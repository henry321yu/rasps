...
def send_file_over_network():
    try:
        ...
        for file_name in txt_files:
            ...
            # 傳送檔案名稱
            # s.sendall(f"FILENAME:{file_name}".encode('utf-8'))
            ...
            with open(file_path, 'r', encoding='utf-8') as file:
                for line in file:
                    ...
                    print(f'Sent line: {line.strip()}')


            ######### 移動並刪除檔案
            # 指定資料夾和檔案路徑
            # folder_A = r'/home/rasp3/Desktop/log_test_by_fly'  # 替換成資料夾 A 的路徑
            folder_C = r'/home/rasp3/Desktop/log_backup_by_fly'  # 替換成資料夾 C 的路徑
            # file_B = file_name  # 替換成要移動的檔案名稱
            ...
            try:
                ...
                # 檢查檔案是否在資料夾 C 中存在，確認移動成功後刪除資料夾 A 中的檔案
        ...
        print(f"Failed to connect within 5 seconds. Error: {e}")
